...
package com.semanticcms.dia.model.book;
...
@WebServlet("/dia/model/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
      ...
      "/dia/model/apidocs/com.semanticcms.dia.model/com" + Objects.toString(req.getPathInfo(), ""),
